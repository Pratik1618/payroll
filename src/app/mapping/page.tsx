...
export default function CycleMappingPage() {
    ...
    const handleEditMapping = (mapping: {
        ...
        setSelectedCycle(mapping.cycleId)
        setMappedSites(mapping.sites)
        setEditingMappingId(mapping.id)
        toast.success("Edit mode enabled — you can now update this mapping.")
    }
            ...
            <div className="space-y-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-6">
                        ...
                        {/* Create Button */}
                        <Button
                            onClick={editingMappingId ? handleUpdateMapping : handleCreateMapping}
                            className="w-full"
